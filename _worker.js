...
let addresses = [
	'hk.edachantv.sbs#优选香港',
	'jp.edachantv.sbs#优选日本',
	'us.edachantv.sbs#优选美国',
	'sg.edachantv.sbs#优选新加坡',
];

// 设置优选地址api接口
let addressesapi = [
	'https://cf-workers-text2kv-9qx.pages.dev/ip.txt?token=cs', //可参考内容格式 自行搭建。
...
let DLS = 8;//速度下限
let addressescsv = [
	'https://6e3f4ee7.cf-workers-text2kv-9qx.pages.dev/result.csv?token=cs', //iptest测速结果文件。
];
...
let noTLS = 'true'; //改为 true ,false 将不做域名判断 始终返回noTLS节点
let link = '';
let edgetunnel = 'ed';
let RproxyIP = 'false';
